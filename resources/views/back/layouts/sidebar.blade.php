...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse  @if(Request::segment(2)==" makaleler" ) show @endif"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Makaleler</h6>
                <a class="collapse-item @if(Request::segment(2)==" makaleler" and !Request::segment(3) ) show @endif"
                    href="{{route('admin.makaleler.create')}}">Makale Oluştur</a>
                <a class="collapse-item  @if(Request::segment(3)==" index") active @endif"
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse  @if(Request::segment(2)==" sayfalar" ) show @endif"
            aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Sayfalar</h6>
                <a class="collapse-item @if(Request::segment(2)==" sayfalar" and !Request::segment(3) ) show @endif"
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="{{route('admin.config.setting')}}">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">@yield("title","Anasayfa")</h1>
                <a href="{{route("homepage")}}" target="_blank"
                    class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        class="fa-sm text-white-50"></i> Siteyi Görüntüle</a>
            </div>